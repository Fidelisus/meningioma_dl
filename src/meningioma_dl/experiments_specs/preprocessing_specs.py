...
PREPROCESSING_SPECS: Dict[str, Dict[str, Any]] = {
    ...
    "histogram_shift_20": {"histogram_shift_num_control_points": 20},
    "histogram_shift_40": {"histogram_shift_num_control_points": 40},
    "histogram_shift_50": {"histogram_shift_num_control_points": 50},
    "histogram_shift_100": {"histogram_shift_num_control_points": 100},
